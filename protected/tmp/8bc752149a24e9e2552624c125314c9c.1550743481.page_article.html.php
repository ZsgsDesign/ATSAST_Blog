    ...
    <head>
        ...
        <style>
            ...
            *{
            ...
            .container .left_box .aside .font_s{
                font-size: 15px;
                padding-top: 10px;
                color: rgba(0,0,0,.87);
            }
            .container .left_box .aside:hover{
            ...
            <div class="container">
                <div class="left_box">
                    <div class="aside">
                        ...
                        <label for="author" class="font"><span>作者名<!----></span></label>
                        <div class="content">
                            <ul>
                                <li>
                                    <img src="/src/image/K_Anna.jpg" width="120px" height="120px">
                                </li>
                                <li>
                                    <a class="font_s">关注 0 | 粉丝 0</a>
                                </li>
                                <li>
                                    <a class="font_s">关注/取关</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="aside">
                            <input type="radio" name="accordion-1" id="sth" />
                            <label for="sth" class="font"><span>rua!<!----></span></label>
                    </div>
                </div>
                <div class="main_box">
